			...
			<div class="col-md-7" style="padding: 0 0 0 0">
				<div class="col-md-12" style="margin-top: 10px;">
					<div class="col-md-6" style="font-size: 16px;">
						...
						<a href="folder.php" style="background-color: white"><i class="fa fa-angle-double-left"></i><u>   <i class="fa fa-folder-o" style="color: yellow;background-color: "></i> <?php $folder=$_SESSION['foldername']; echo "$folder"; ?></u></a>
					</div>

					<div class="col-md-6 ">
									
						<button class="btn btn-success" data-toggle='collapse' data-target="#myfiles"><i class="fa fa-cloud-upload"></i> upload</button>
						<div class="col-md-12 collapse" id="myfiles">
							<form method="post" action="main.php" enctype="multipart/form-data" class="">
								<input type="file" name="uploadfile" class="">
								<input type="submit" name="uploadinfolder" value="upload" class="btn btn-success">
							</form>
						</div>						
					</div>
					<!-- <br> -->
